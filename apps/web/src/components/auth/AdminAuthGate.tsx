            ...
            <Card className="w-full max-w-md">
                <CardHeader>
                    <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground">
                        ZyvorAI control plane
                    </p>
                    <CardTitle>
                        {setupRequired ? "Create your admin password" : "Sign in to ZyvorAI"}
                    </CardTitle>
                    <CardDescription>
                        {setupRequired
        ...
        <main className="flex min-h-svh items-center justify-center bg-background px-4 py-8">
            <Card className="w-full max-w-md">
                <CardHeader>
                    ...
                    <CardDescription>
                        ZyvorAI could not verify the admin session. Make sure the API is running and
                        try again.
                    </CardDescription>
                </CardHeader>
                <CardContent>
