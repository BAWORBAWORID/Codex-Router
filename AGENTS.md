...
- Styling uses the OKLCH theme tokens in `styles.css`; versions come from `@codex/constants`.

## CLI practice

- Any command that writes tool config snapshots the original into `~/.codex/backups/` first.
